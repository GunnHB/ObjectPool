...
AObjectPoolCharacter::AObjectPoolCharacter()
{
...
void AObjectPoolCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AObjectPoolCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AObjectPoolCharacter::Move);
...
void AObjectPoolCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AObjectPoolCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
